...
/*			Thread thread4 = new Thread(new TCPClient_Initiative(socket4));
			...
			exec.scheduleAtFixedRate(thread,  3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread1, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread2, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread3, 3000, 3000, TimeUnit.MILLISECONDS);
/*			exec.scheduleAtFixedRate(thread4, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread5, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread6, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread7, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread8, 3000, 3000, TimeUnit.MILLISECONDS);
			exec.scheduleAtFixedRate(thread9, 3000, 3000, TimeUnit.MILLISECONDS);*/
	...
	public synchronized static  void handleClientSockets(){

package demo.everything.primitive.number;

import java.util.Arrays;

public class _TestNumber {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		/*System.out.println(Arrays.toString(intToBytes(-1)));
		System.out.println(Arrays.toString(intToBytes2(-1)));
		*/
		
		//00 00 00 00 00 00 3F F0 
		//00 00 00 00 00 00 40 00 
		//00 00 00 00 00 00 40 08
		System.out.println(Arrays.toString(doubleToBytes(1)));
		System.out.println(Arrays.toString(doubleToBytes(2)));
		System.out.println(Arrays.toString(doubleToBytes(3)));
	}
	...
	public static short toUnsignedInt1(byte x) {
		return (short) (x & 0xff);
	}

...
CREATE SEQUENCE "public"."aplus_metric_datas_histrory_seq"
 INCREMENT 1
 MINVALUE 1
 MAXVALUE 9223372036854775807
 START 1
...
ALTER TABLE "public"."aplus_metric_datas_histrory_seq" OWNER TO "postgres";

SELECT setval('"public"."aplus_metric_datas_histrory_seq"', 1, true);
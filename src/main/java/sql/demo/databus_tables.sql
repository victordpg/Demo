...
"fqn" varchar COLLATE "default" NOT NULL,
"fn" varchar COLLATE "default",
"monitor_data" text COLLATE "default" NOT NULL,
"record_time" int8 NOT NULL,
"freeze_time" varchar(20) COLLATE "default",
"freeze_density" varchar(2) COLLATE "default",
...
COMMENT ON COLUMN "public"."aplus_metric_history_data"."freeze_time" IS '冻结数据的冻结时间，取自指标中的冻结时间。冻结的时间样式如下：
日冻结：2015-12-15 16:00:00
月冻结：2015-11-00 00:00:00
曲线冻结：2015-12-12 15:15:00';

COMMENT ON COLUMN "public"."aplus_metric_history_data"."freeze_density" IS '曲线冻结数据的冻结密度。分别为：00（不冻结）,01（1分钟）,05（5分钟）,15（15分钟）,30（30分钟）,60（60分钟）.';



CREATE INDEX "index_metric_history_data__fff" ON "public"."aplus_metric_history_data" USING btree (fqn, fn, freeze_time);
...
CREATE INDEX "index_metric_history_data__freezedensity" ON "public"."aplus_metric_history_data" USING btree (freeze_density);

CREATE INDEX "index_metric_history_data__freezetime" ON "public"."aplus_metric_history_data" USING btree (freeze_time);
